...
public class BitBucketProjectSettingsTests
{
    ...
    {
        // Arrange
        var propertyInfo = typeof(BitBucketProjectSettings).GetProperty(nameof(BitBucketProjectSettings.TargetBranch));
    ...
    {
        // Arrange
        var propertyInfo = typeof(BitBucketProjectSettings).GetProperty(nameof(BitBucketProjectSettings.TargetBranches));
